...
func (_m *AuthServiceInterface) GenerateTokensAndSetCookies(c echo.Context, user *responses.UserInfo) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(echo.Context, *responses.UserInfo) error); ok {
		r0 = rf(c, user)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *AuthServiceInterface_GenerateTokensAndSetCookies_Call) Run(run func(c echo.Context, user *responses.UserInfo)) *AuthServiceInterface_GenerateTokensAndSetCookies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(echo.Context), args[1].(*responses.UserInfo))
	})
	return _c
}
...
func (_c *AuthServiceInterface_GenerateTokensAndSetCookies_Call) RunAndReturn(run func(echo.Context, *responses.UserInfo) error) *AuthServiceInterface_GenerateTokensAndSetCookies_Call {
	_c.Call.Return(run)
	return _c
}
